...
import com.kaifan.emloyeeManagement.mapper.LeaveBalanceMapper;
...
//            }
    ...
    @Override
    public LeaveBalanceResponseDto getLeaveBalanceForEmployee(int year) {
        String employeeId = securityUtils.getCurrentEmployeeId();
        List<LeaveBalance> leaveBalances = leaveBalanceRepository.findByEmployeeIdAndYear(employeeId, year);
        LeaveBalanceResponseDto leaveBalanceResponseDto = new LeaveBalanceResponseDto();
        leaveBalanceResponseDto.setEmployeeId(employeeId);
        leaveBalanceResponseDto.setLeaveBalances(leaveBalanceMapper.toDtoList(leaveBalances));
